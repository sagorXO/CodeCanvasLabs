...
// Inline SVG tech logos — actual brand marks, with explicit style constraints
const PARTNERS = [
  {
    name: 'Vercel',
    svg: (
      <svg className="h-5 w-auto" style={{ height: '20px', width: 'auto' }} viewBox="0 0 76 65" fill="currentColor">
  ...
  },
  {
    name: 'Supabase',
    svg: (
      <svg className="h-5 w-auto" style={{ height: '20px', width: 'auto' }} viewBox="0 0 109 113" fill="none">
  ...
  },
  {
    name: 'Next.js',
    svg: (
      <svg className="h-5 w-auto" style={{ height: '20px', width: 'auto' }} viewBox="0 0 394 80" fill="currentColor">
  ...
  },
  {
    name: 'Stripe',
    svg: (
      <svg className="h-5 w-auto" style={{ height: '20px', width: 'auto' }} viewBox="0 0 60 25" fill="currentColor">
  ...
  },
  {
    name: 'Railway',
    svg: (
      <svg className="h-5 w-auto" style={{ height: '20px', width: 'auto' }} viewBox="0 0 24 24" fill="currentColor">
  ...
  },
  {
    name: 'PlanetScale',
    svg: (
      <svg className="h-5 w-auto" style={{ height: '20px', width: 'auto' }} viewBox="0 0 256 256" fill="currentColor">
